...
<head>
    ...
    <title>@yield('title', 'Participant Dashboard') - CompetiGo</title>
...
<body class="min-h-screen flex flex-col">
    ...
    <div class="flex flex-1">
        {{-- Sidebar Participant --}}
        @include('components.sidebar-participant')
        ...
        <main class="flex-1 bg-[#FFF7F4] p-8 overflow-y-auto">
            ...
            <div class="mb-6 border-b-2 border-indigo-200 pb-3 flex justify-between items-center">
                <h1 class="text-2xl font-bold text-[#5D688A]">@yield('title', 'Dashboard Participant')</h1>
            </div>
