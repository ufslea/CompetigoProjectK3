...
<div class="flex">
    ...
    <div class="flex-1 px-8 py-6">
        ...
        <h1 class="text-2xl font-bold text-[#1D3557] mb-6">Tambah Pengumuman</h1>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            <form action="{{ route('organizer.announcements.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <select name="events_id" 
                        ...
                        @foreach($events as $event)
                            <option value="{{ $event->events_id }}" @selected(old('events_id') == $event->events_id)>
                                {{ $event->nama }}
                            </option>
                        @endforeach
                    </select>
