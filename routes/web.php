...
Route::middleware(['auth', 'organizer'])
    ...
    ->group(function () {
        ...
        Route::delete('/results/{id}', [HasilController::class, 'destroy'])->name('results.destroy'); // FIXED
...
Route::prefix('organizer')->name('organizer.')->group(function () {
    Route::post('participants/{id}/verify', [PartisipanController::class, 'verify'])
        ->name('participants.verify');

    Route::post('participants/{id}/reject', [PartisipanController::class, 'reject'])
        ->name('participants.reject');

    // route lain yang udah ada, misal index, show
    Route::get('participants', [PartisipanController::class, 'index'])->name('participants.index');
    Route::get('participants/{id}', [PartisipanController::class, 'show'])->name('participants.show');
});

Route::prefix('participant/competitions')->name('competitions.')->group(function () {
    Route::get('/{competition}/announcement', [PengumumanController::class, 'announcement'])->name('announcement');
});
...
Route::prefix('participant')->name('participant.')->group(function() {
    Route::get('results', [HasilController::class, 'index'])->name('results.index');
    Route::get('results/certificates', [HasilController::class, 'certificates'])->name('results.certificates');
});
